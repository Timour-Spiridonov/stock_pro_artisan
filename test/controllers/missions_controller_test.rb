...
class MissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mission" do
    assert_difference("Mission.count") do
      post missions_url, params: { mission: { description: @mission.description, end_at: @mission.end_at, price: @mission.price, start_at: @mission.start_at } }
    end
  ...
  test "should update mission" do
    patch mission_url(@mission), params: { mission: { description: @mission.description, end_at: @mission.end_at, price: @mission.price, start_at: @mission.start_at } }
